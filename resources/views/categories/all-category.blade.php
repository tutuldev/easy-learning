...
<a href="{{ route('categories.create') }}" class=" text-white px-2 py-1 text-sm rounded-md bg-green-600 hover:bg-green-700 my-2 inline-block">Add<span class="material-symbols-outlined align-middle text-sm mx-2">add</span></a>
      ...
      <tbody>
        ...
        <tr class="hover:bg-gray-50">
          ...
          <td class="flex space-x-4 justify-center">
            <a href="{{route('categories.edit',$category->id)}}" class="text-white px-2 py-1 rounded-md bg-sky-600 hover:bg-sky-700 text-sm">Edit</a>
