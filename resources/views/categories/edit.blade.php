@extends('backend.app')
@section('content')
<h2 class="mt-16 text-2xl font-semibold ">Edit Category</h2>
...
<form action="{{ route('categories.update', $category->slug) }}" method="POST" class="max-w-sm  bg-white p-6 rounded-lg shadow">
    @csrf
    @method('PUT')
