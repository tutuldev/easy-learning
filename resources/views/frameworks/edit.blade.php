@extends('backend.app')
@section('content')
<h2 class="text-2xl font-semibold ">Edit Framework</h2>
...
<form action="{{ route('frameworks.update', $framework->id) }}" method="POST" class="max-w-sm  bg-white p-6 rounded-lg shadow">
    @csrf
    @method('PUT')
