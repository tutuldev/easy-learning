...
<form action="{{ route('frameworks.update', $framework->slug) }}" method="POST" class="  bg-white p-6 rounded-lg shadow">
    @csrf
    @method('PUT')
    ...
    <div>
        ...
        <textarea id="description" name="description" rows="10"
                class="w-full border border-gray-300 rounded p-2">{{ old('description', $framework->description) }}</textarea>
        @error('description')
