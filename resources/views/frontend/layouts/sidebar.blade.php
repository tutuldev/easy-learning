...
<div class="md:w-64">
    <!-- Sidebar -->
    <aside id="sidebar"
        class="fixed top-24 md:left-auto left-0 z-20 w-64 bg-white shadow-md overflow-y-auto transform -translate-x-full transition-transform duration-300 ease-in-out md:translate-x-0">
